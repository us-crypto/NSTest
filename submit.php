        ...
        <div class=" col-md-6 contact_form-container">
          <div class="contact_box">
            ...
            if (isset($_POST['Name']) && (isset($_POST['Email']))) {
              $sql = 'INSERT INTO `messages_tb`(`Name`, `Email`, `tel`, `message`)
                      VALUES (' . $conn->real_escape_string($_POST["Name"]) . ', ' . $conn->real_escape_string($_POST["Email"]) . ',
                      ' . $conn->real_escape_string($_POST["Number"]) . ', ' . $conn->real_escape_string($_POST["Message"]) . ');';
              $stmt = $conn->prepare($sql);
              $stmt->execute();
              echo "<strong> Your message has been send. thanks </strong>  ";
            }
